...
Estado_Solicitud TINYINT(1) DEFAULT 0 NOT NULL,

CONSTRAINT PK_SOLICITUDCUENTA PRIMARY KEY (ID),
CONSTRAINT FK_SOLICITUDCUENTA_USUARIOS FOREIGN KEY (DNICliente) REFERENCES Usuarios (DNI)
);
...
ALTER TABLE Prestamos ADD CONSTRAINT FK_PRESTAMOS_NUMEROCUOTAS FOREIGN KEY (ID_Numero_Cuotas) REFERENCES Numero_Cuotas (ID);
